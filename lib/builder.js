...
// bypassing original setup with a global var until we can figure out what's going on here
var _relativeImagePath;
...
SpriteSheetBuilder = (function() {
  ...
  function SpriteSheetBuilder(options) {
    ...
    _relativeImagePath = options.relativeImagePath;
...
SpriteSheetConfiguration = (function() {
  function SpriteSheetConfiguration(files, options) {
    ...
    if (options.outputImage) {
      this.outputImageFilePath = options.outputImage;
  ...
  SpriteSheetConfiguration.prototype.generateCSS = function() {
    return this.css = this.style.generate({
      relativeImagePath: _relativeImagePath, // forcing ability to directly set relative path
      images: this.images,
